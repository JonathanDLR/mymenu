...
public class OrderTest {
    ...
    @Test
    public void Given__Chicken_When_DisplayMenuSelected_Then_DisplayChickenSentence() {
        order.displaySelectedMenu(1);
        assertEquals("Vous avez choisi comme menu: poulet\n", outContent.toString().replace("\r\n", "\n"));
    }

    @Test
    public void Given__Beef_When_DisplayMenuSelected_Then_DisplayBeefSentence() {
    ...
    @Test
    public void Given_BadValueAndAllSide_When_DisplaySideSelected_Then_DisplayErrorSentence() {
    ...
    @Test
    public void Given_BadValueAndNotAllSide_When_DisplaySideSelected_Then_DisplayErrorSentence() {
    ...
    @Test
    public void Given_OneMenuChickenWithFriesAndSodaInStandardInput_When_MenuIsRun_Then_DisplayCorrectProcess() {
        System.setIn(new ByteArrayInputStream("1\n1\n2\n3\n".getBytes()));
        order = new Order();
        order.runMenus();
        String[] output = outContent.toString().replace("\r\n", "\n").split("\n");
        ...
        assertEquals("Vous avez choisi comme boisson: Soda", output[13]);
    }
    ...
    public void Given_TwoMenu_BeefWithVegetable_VegetarianWithNoRiceAndSparklingWaterInStandardInput_When_MenusIsRun_Then_DisplayCorrectProcess() {
        ...
        assertEquals("Vous avez choisi comme boisson: Eau Gazeuse", output[24]);
    }
    ...
    public void Given_ChickenWithBadSideAndBadDrink_When_MenuIsRun_Then_ReAskSideAndDrink() {
        ...
        assertEquals("Vous avez choisi comme accompagmenent: frites", output[12]);
    ...
    public void Given_VegetarianWithBadSideAndBadDrink_When_MenuIsRun_Then_ReAskSideAndDrink() {
        ...
        assertEquals("Vous avez choisi comme accompagmenent: pas de riz", output[11]);
    ...
    @Test
    public void Given_FriesWithAllSideEnabled_When_AskAboutSides_Then_DisplayFriesChoice() {
        System.setIn(new ByteArrayInputStream("2\n".getBytes()));
        order = new Order();
        order.askSide(true);
        String[] output = outContent.toString().replace("\r\n", "\n").split("\n");
    ...
    public void Given_Water_When_AskAboutDrinks_Then_DisplayWaterChoice() {
        ...
        order.askDrink();
        String[] output = outContent.toString().replace("\r\n", "\n").split("\n");
        assertEquals("Vous avez choisi comme boisson: Eau", output[5]);
    }

    @Test
    public void Given_Chicken_When_AskAboutMenus_Then_ReturnNumber1() {
        System.setIn(new ByteArrayInputStream("1\n".getBytes()));
        order = new Order();
    ...
    public void Given_Responses_When_CallingRunMenus_Then_FillOrderSummaryCorrectly() {
        ...
        assertEquals("Résumé de votre commande: %n" +
                     ...
                     "Vous avez choisi comme boisson: Eau%n" +
                     "Menu 2:%n" +
